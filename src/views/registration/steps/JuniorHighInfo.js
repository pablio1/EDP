...
export class JuniorHighInfo extends Component {
                ...
                <div>
                    ...
                    <div class="row">                   
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" className="form-control" id="ESCschoolID"  required name="esc_SchoolID" value={values.esc_SchoolID} onChange={inputChange('esc_SchoolID')}/>
                        </div>
                    </div>
                    <div className="row">
